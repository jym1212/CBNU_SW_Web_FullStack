...
const EntryPlus = () => {
  ...
  //Input 요소 타입 이벤트 핸들러 정의
  //화면 내 모든 Input 요소의 onChange 이벤트 핸들러를 단일처리 함수로 정의
  //참조형 데이터(객체, 배열) 변경은 반드시 참조형 데이터의 복사본을 생성하고 해당 복사본 속성 변경
  const handleMemberInput = (e: React.ChangeEvent<HTMLInputElement>) => {
    //...member : 해당 객체의 복사본 생성
    //복사본의 해당 UI 요소의 name값을 이용해 객체 속성 값을 변경
    //member 객체의 실제 복사본 객체를 생성하고, 복사본 객체의 특정속성["속성명"]을 지정
    //지정한 후, 값을 변경하고 복사본을 setMember() 함수에 값을 전달하여 member 객체를 변경
    console.log('onChange 이벤트 발생한 UI 요소의 name 값 :', e.target.name);
    console.log('onChange 이벤트 발생한 UI 요소의 value 값 :', e.target.value);
    setMember({ ...member, [e.target.name]: e.target.value });
  };

  //Select 요소 타입 이벤트 핸들러 정의
  ...
  //Textarea 요소 타입 이벤트 핸들러 정의
  const handleMemberTextarea = (e: React.ChangeEvent<HTMLTextAreaElement>) => {
    console.log('onChange 이벤트 발생한 UI 요소의 name 값 :', e.target.name);
    console.log('onChange 이벤트 발생한 UI 요소의 value 값 :', e.target.value);
  ...
  //Checkbox 요소 타입 이벤트 핸들러 정의
  const handleMemberCheckbox = (e: React.ChangeEvent<HTMLInputElement>) => {
    console.log('onChange 이벤트 발생한 UI 요소의 name 값 :', e.target.name);
    console.log('onChange 이벤트 발생한 UI 요소의 value 값 :', e.target.value);
    setMember({ ...member, agreed: e.target.checked });
