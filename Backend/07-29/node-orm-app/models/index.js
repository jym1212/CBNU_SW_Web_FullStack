...
/*
Sequelize ORM 주요 폴더 설명
- config : DB 연결 정보 환경 설정 파일
- models : 테이블과 맵핑 되는 모델 정의 파일 보관, 모델 기반 프로그래밍 처리 모듈 제공
- migrations : 구조 변경 마이그레이션 계획 정보 기록 (테이블 생성, 변경, 삭제 등)
- seeders : 테이블 생성 시, 초기 데이터 생성 설정 
*/
...
//회원 모델 모듈 파일 참조하고, DB 속성 정의
db.Member = require('./member.js')(sequelize, Sequelize);

//게시글 모델 모듈 파일 참조하고, DB 속성 정의
